...
SCORE_THRESHOLD_AUTO: int = 60

SCORE_TIME_UNDER_1H: int = 40
SCORE_TIME_UNDER_12H: int = 25
SCORE_TIME_UNDER_3D: int = 10
SCORE_TIME_UNDER_1H_MAX_SECONDS: int = 3600
SCORE_TIME_UNDER_12H_MAX_SECONDS: int = 12 * 60 * 60
SCORE_TIME_UNDER_3D_MAX_SECONDS: int = 3 * 24 * 60 * 60
